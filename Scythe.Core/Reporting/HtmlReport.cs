...
namespace Scythe.Core.Reporting;
...
public static class HtmlReport
{
    public static void Write(string path, ScanReport report)
    {
        ...
        sb.Append("<!DOCTYPE html><html><head><meta charset=\"utf-8\"><title>Scythe Scan Report — ")
        ...
        sb.Append("<h1>Scythe Scan Report</h1><p class=\"muted\">Host <b>").Append(H(report.Host))
