...
/// nothing in this type (or in Scythe.Core at all) exposes a destructive operation —
/// remediation lives exclusively in the Scythe.Remediation module (spec §8).</summary>
