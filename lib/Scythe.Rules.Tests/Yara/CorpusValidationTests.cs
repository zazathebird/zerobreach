...
public class CorpusValidationTests
{
        ...
        double mibPerSec)
    {
        ...
        sb.AppendLine();
        sb.AppendLine("Generated by `CorpusValidationTests` (Scythe.Rules.Tests). The corpus is");
...
public class DifferentialVerdictTests
{
    ...
    {
        string dir = Path.Combine(Path.GetTempPath(), "scythe-yara-verdict-" + Guid.NewGuid().ToString("N"));
