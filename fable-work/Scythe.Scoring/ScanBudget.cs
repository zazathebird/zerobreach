...
/// <summary>
/// The resource ceiling a caller imposes on one rollup. Shape is fixed across the package
...
/// </summary>
/// <remarks>
/// The rollup takes structured records rather than bytes and does not recurse, so only
/// <see cref="MaxMatches"/> binds here: it caps the number of checks plus findings the rollup
/// will tally. The other three members are carried unused rather than dropped, because a caller
/// sets one budget for a whole artifact and hands the same object to every reader.
/// </remarks>
