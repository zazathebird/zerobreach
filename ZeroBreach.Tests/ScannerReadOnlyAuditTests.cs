...
/// surface is ZeroBreach.Remediation and nothing else. This test greps the scanner (and
...
public class ScannerReadOnlyAuditTests
{
    ...
    public static IEnumerable<object[]> ScannerSources() => SourcesOf("ZeroBreach.Scanners");
    ...
    public static IEnumerable<object[]> CoreScanningSources() =>
        SourcesOf("ZeroBreach.Core").Where(o =>
    ...
    public void Source_file_contains_no_destructive_api_calls(string sourceFile)
    {
        ...
        Assert.True(hits.Count == 0,
            ...
            "destructive logic belongs only in ZeroBreach.Remediation.");
    }
    ...
    public void Scanner_project_exists_and_audit_found_its_sources()
    {
        ...
        Assert.NotEmpty(SourcesOf("ZeroBreach.Core"));
    }
    ...
    private static string FindRepoRoot()
    {
        ...
        while (dir is not null && !File.Exists(Path.Combine(dir, "ZeroBreach.sln")))
            dir = Path.GetDirectoryName(dir);
        return dir ?? throw new InvalidOperationException("ZeroBreach.sln not found above test dir");
    }
}
