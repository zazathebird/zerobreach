...
$tests = @(
    ...
    @{ Name = 'LINT signature-lint contract (call sites + manifest)'; File = 'Test-Signature-Lint.ps1' }
    @{ Name = 'LINT allowlist anchors + thumbprint root trust'; File = 'Test-Allowlist-Anchors.ps1'; Strict = $true }
