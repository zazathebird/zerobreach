...
:launch_ps
echo.
echo  [Scythe] Launching Scythe-Server.ps1 ...
echo  [Scythe] Tip: run "Launch-GUI.bat python" to use the Python/Flask server instead.
echo.

set "LOGFILE=%~dp0scythe_launch_error.log"

powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0Scythe-Server.ps1" 2>"%LOGFILE%"
...
if %PS_EXIT% neq 0 (
    echo.
    echo  ╔══════════════════════════════════════════════════════════╗
    echo  ║  Scythe-Server.ps1 exited with code %PS_EXIT%              ║
    echo  ║  Errors written to: scythe_launch_error.log         ║
    echo  ╚══════════════════════════════════════════════════════════╝
    echo.
    type "%LOGFILE%"
    echo.
...
:launch_python
echo.
echo  [Scythe] Launching Python/Flask server (_python\server.py)...
echo.
...
echo  [Scythe] Checking Python dependencies...
...
echo  [Scythe] Starting Flask server...
