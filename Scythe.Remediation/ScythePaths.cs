...
public static class ScythePaths
{
    /// <summary>Data root for the vault and action log: %ProgramData%\Scythe, falling
    ...
    public static string DataRoot
    {
        get
        {
            ...
            var root = Path.Combine(pd, "Scythe");
            try
            {
            ...
            catch
            {
                ...
                var alt = Path.Combine(exeDir, "ScytheData");
